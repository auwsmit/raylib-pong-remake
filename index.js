...
var ASM_CONSTS = {
  93616: () => { if (document.fullscreenElement) return 1; },  
 93662: () => { return document.getElementById('canvas').width; },  
 93714: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 93928: () => { return document.getElementById('canvas').width; },  
 93980: () => { return screen.width; },  
 94005: () => { document.exitFullscreen(); },  
 94032: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 94165: () => { return window.innerWidth; },  
 94191: () => { return window.innerHeight; },  
 94218: () => { if (document.fullscreenElement) return 1; },  
 94264: () => { return document.getElementById('canvas').width; },  
 94316: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94384: () => { if (document.fullscreenElement) return 1; },  
 94430: () => { return document.getElementById('canvas').width; },  
 94482: () => { return screen.width; },  
 94507: () => { return window.innerWidth; },  
 94533: () => { return window.innerHeight; },  
 94560: () => { if (document.fullscreenElement) return 1; },  
 94606: () => { return document.getElementById('canvas').width; },  
 94658: () => { return screen.width; },  
 94683: () => { document.exitFullscreen(); },  
 94710: () => { if (document.fullscreenElement) return 1; },  
 94756: () => { return document.getElementById('canvas').width; },  
 94808: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94876: () => { document.exitFullscreen(); },  
 94903: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 94961: () => { return screen.width; },  
 94986: () => { return screen.height; },  
 95012: () => { return window.screenX; },  
 95039: () => { return window.screenY; },  
 95066: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 95119: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 95190: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 95247: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95503: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 95574: () => { if (document.fullscreenElement) return 1; },  
 95620: () => { return window.innerWidth; },  
 95646: () => { return window.innerHeight; },  
 95673: () => { if (document.pointerLockElement) return 1; }
};
