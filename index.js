...
var ASM_CONSTS = {
 ...
 93730: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 93944: () => { return document.getElementById('canvas').width; },  
 93996: () => { return screen.width; },  
 94021: () => { document.exitFullscreen(); },  
 94048: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 94181: () => { return window.innerWidth; },  
 94207: () => { return window.innerHeight; },  
 94234: () => { if (document.fullscreenElement) return 1; },  
 94280: () => { return document.getElementById('canvas').width; },  
 94332: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94400: () => { if (document.fullscreenElement) return 1; },  
 94446: () => { return document.getElementById('canvas').width; },  
 94498: () => { return screen.width; },  
 94523: () => { return window.innerWidth; },  
 94549: () => { return window.innerHeight; },  
 94576: () => { if (document.fullscreenElement) return 1; },  
 94622: () => { return document.getElementById('canvas').width; },  
 94674: () => { return screen.width; },  
 94699: () => { document.exitFullscreen(); },  
 94726: () => { if (document.fullscreenElement) return 1; },  
 94772: () => { return document.getElementById('canvas').width; },  
 94824: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94892: () => { document.exitFullscreen(); },  
 94919: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 94977: () => { return screen.width; },  
 95002: () => { return screen.height; },  
 95028: () => { return window.screenX; },  
 95055: () => { return window.screenY; },  
 95082: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 95135: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 95206: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 95263: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95519: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 95590: () => { if (document.fullscreenElement) return 1; },  
 95636: () => { return window.innerWidth; },  
 95662: () => { return window.innerHeight; },  
 95689: () => { if (document.pointerLockElement) return 1; }
};
