...
var ASM_CONSTS = {
 ...
 95050: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 95103: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 95174: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 95231: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95487: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 95558: () => { if (document.fullscreenElement) return 1; },  
 95604: () => { return window.innerWidth; },  
 95630: () => { return window.innerHeight; },  
 95657: () => { if (document.pointerLockElement) return 1; }
};
